            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('diary.update', $diaryEntry) }}">
                        ...
                        {{-- Emotion --}}
                        <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray300 mb-2">Select Emotions</label>
                        ...
                        dark:text-gray-100 dark:border-gray-600 focus:ring-indigo-500 focus:borderindigo-500" placeholder="Intensity" min="1" max="10"
